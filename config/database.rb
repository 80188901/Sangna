...
database_name = case Padrino.env
  when :development then 'sanna_development'
  when :production  then 'sanna_production'
  when :test        then 'sanna_test'
end
...
#     sessions:
#       default:
#         database: sanna_development
#         hosts:
#           - localhost:27017
#   production:
#     sessions:
#       default:
#         database: sanna_production
#         hosts:
#           - localhost:27017
#   test:
#     sessions:
